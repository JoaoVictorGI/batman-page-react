  ...
  return (
    <>
      <div className="bg-contatos-background bg-[50% 50%] bg-cover w-full h-[800px]">
        <section className="bg-opacity-0 w-full h-[800px] md:pl-36 flex flex-col justify-center items-center md:items-start">
          ...
          <form className="bg-opacity-0 mt-12 w-1/2 h-[500px] flex flex-col items-center md:items-start md:grid">
